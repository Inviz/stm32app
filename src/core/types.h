...
typedef app_signal_t (*device_event_handler_t)(void *object, app_event_t *event);
typedef app_task_signal_t (*device_task_t)(app_task_t *task);
typedef app_signal_t (*device_callback_phase_t)(void *object, device_phase_t phase);
typedef app_signal_t (*device_callback_value_t)(void *object, device_t *device, void *value, void *argument);
typedef app_signal_t (*device_callback_argument_t)(void *object, device_t *device, void *argument);
typedef app_signal_t (*device_callback_signal_t)(void *object, device_t *device, app_signal_t signal, void *argument);
