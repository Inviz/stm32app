...
#define SUBIDX_ADC_INDEX 0x2
#define SUBIDX_ADC_INTERVAL 0x3
#define SUBIDX_ADC_SAMPLE_COUNT_PER_CHANNEL 0x4
#define SUBIDX_ADC_DMA_UNIT 0x5
#define SUBIDX_ADC_DMA_STREAM 0x6
#define SUBIDX_ADC_DMA_CHANNEL 0x7
