...
/* 0x71XX04: null */
#define storage_w25_set_phase(w25, value) device_set_property_numeric(w25->device, (uint32_t) value, sizeof(uint8_t), STORAGE_W25_PHASE)
#define storage_w25_get_phase(w25) *((uint8_t *) device_get_property_pointer(w25->device, &(uint8_t[sizeof(uint8_t)]{}), sizeof(uint8_t), STORAGE_W25_PHASE)
