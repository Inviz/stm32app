...
static app_signal_t w25_validate(OD_entry_t *config_entry) {
    storage_w25_config_t *config = (storage_w25_config_t *)OD_getPtr(config_entry, 0x00, 0, NULL);
    (void)config;
    if (false) {
...
static app_signal_t w25_phase_constructing(storage_w25_t *w25, device_t *device) {
    w25->config = (storage_w25_config_t *)OD_getPtr(device->config, 0x00, 0, NULL);
