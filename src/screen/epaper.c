...
static ODR_t epaper_values_property_write(OD_stream_t *stream, const void *buf, OD_size_t count, OD_size_t *countWritten) {
...
device_methods_t screen_epaper_methods = {
    ...
    .property_write = epaper_values_property_write,
};
