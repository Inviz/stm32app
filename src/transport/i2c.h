...
#define transport_i2c_set_phase(i2c, value) OD_set_u8(i2c->device->properties, TRANSPORT_I2C_PHASE, value, false)
#define transport_i2c_get_phase(i2c) *((uint8_t *) OD_getPtr(i2c->device->class->properties, TRANSPORT_I2C_PHASE, 0, NULL))
