...
extern device_class_t transport_i2c_class;
...
/* 0x62XX0A: null */
#define transport_i2c_set_phase(i2c, value) device_set_property_numeric(i2c->device, (uint32_t) value, sizeof(uint8_t), TRANSPORT_I2C_PHASE)
#define transport_i2c_get_phase(i2c) *((uint8_t *) device_get_property_pointer(i2c->device, &(uint8_t[sizeof(uint8_t)]{}), sizeof(uint8_t), TRANSPORT_I2C_PHASE)
