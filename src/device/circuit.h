...
#define device_circuit_get_phase(circuit) *((uint8_t *) OD_getPtr(circuit->device->class->properties, DEVICE_CIRCUIT_PHASE, 0, NULL))
...
#define device_circuit_get_duty_cycle(circuit) *((uint16_t *) OD_getPtr(circuit->device->class->properties, DEVICE_CIRCUIT_DUTY_CYCLE, 0, NULL))
#define device_circuit_set_current(circuit, value) OD_set_u16(circuit->device->properties, DEVICE_CIRCUIT_CURRENT, value, false)
#define device_circuit_get_current(circuit) *((uint16_t *) OD_getPtr(circuit->device->class->properties, DEVICE_CIRCUIT_CURRENT, 0, NULL))
#define device_circuit_set_voltage(circuit, value) OD_set_u16(circuit->device->properties, DEVICE_CIRCUIT_VOLTAGE, value, false)
#define device_circuit_get_voltage(circuit) *((uint16_t *) OD_getPtr(circuit->device->class->properties, DEVICE_CIRCUIT_VOLTAGE, 0, NULL))
...
#define device_circuit_get_consumers(circuit) *((uint8_t *) OD_getPtr(circuit->device->class->properties, DEVICE_CIRCUIT_CONSUMERS, 0, NULL))
