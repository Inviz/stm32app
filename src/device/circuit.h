...
OD_ACCESSORS(device, circuit, properties, phase, SUBIDX_CIRCUIT_PHASE, uint8_t, u8) /* 0x40XX07: {"description":"Hall sensor measures current and allows circuit to become a circuit breaker","label":null} */
OD_ACCESSORS(device, circuit, properties, duty_cycle, SUBIDX_CIRCUIT_DUTY_CYCLE, uint16_t, u16) /* 0x40XX08: {"description":null,"label":null} */
OD_ACCESSORS(device, circuit, properties, current, SUBIDX_CIRCUIT_CURRENT, uint16_t, u16) /* 0x40XX09: {"description":null,"label":null} */
OD_ACCESSORS(device, circuit, properties, voltage, SUBIDX_CIRCUIT_VOLTAGE, uint16_t, u16) /* 0x40XX0a: {} */
OD_ACCESSORS(device, circuit, properties, consumers, SUBIDX_CIRCUIT_CONSUMERS, uint8_t, u8) /* 0x40XX0b: {} */
