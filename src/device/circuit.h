...
#define device_circuit_set_phase(circuit, value) actor_set_property_numeric(circuit->actor, (uint32_t) value, sizeof(uint8_t), DEVICE_CIRCUIT_PHASE)
#define device_circuit_get_phase(circuit) *((uint8_t *) actor_get_property_pointer(circuit->actor, &(uint8_t[sizeof(uint8_t)]{}), sizeof(uint8_t), DEVICE_CIRCUIT_PHASE)
/* 0x40XX08: Phase x */
#define device_circuit_set_duty_cycle(circuit, value) actor_set_property_numeric(circuit->actor, (uint32_t) value, sizeof(uint16_t), DEVICE_CIRCUIT_DUTY_CYCLE)
#define device_circuit_get_duty_cycle(circuit) *((uint16_t *) actor_get_property_pointer(circuit->actor, &(uint8_t[sizeof(uint16_t)]{}), sizeof(uint16_t), DEVICE_CIRCUIT_DUTY_CYCLE)
/* 0x40XX09: null */
#define device_circuit_set_current(circuit, value) actor_set_property_numeric(circuit->actor, (uint32_t) value, sizeof(uint16_t), DEVICE_CIRCUIT_CURRENT)
#define device_circuit_get_current(circuit) *((uint16_t *) actor_get_property_pointer(circuit->actor, &(uint8_t[sizeof(uint16_t)]{}), sizeof(uint16_t), DEVICE_CIRCUIT_CURRENT)
/* 0x40XX0A: Current  x */
#define device_circuit_set_voltage(circuit, value) actor_set_property_numeric(circuit->actor, (uint32_t) value, sizeof(uint16_t), DEVICE_CIRCUIT_VOLTAGE)
#define device_circuit_get_voltage(circuit) *((uint16_t *) actor_get_property_pointer(circuit->actor, &(uint8_t[sizeof(uint16_t)]{}), sizeof(uint16_t), DEVICE_CIRCUIT_VOLTAGE)
/* 0x40XX0B: null */
#define device_circuit_set_consumers(circuit, value) actor_set_property_numeric(circuit->actor, (uint32_t) value, sizeof(uint8_t), DEVICE_CIRCUIT_CONSUMERS)
#define device_circuit_get_consumers(circuit) *((uint8_t *) actor_get_property_pointer(circuit->actor, &(uint8_t[sizeof(uint8_t)]{}), sizeof(uint8_t), DEVICE_CIRCUIT_CONSUMERS)
