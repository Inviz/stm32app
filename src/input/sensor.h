...
OD_ACCESSORS(input, sensor, properties, phase, SUBIDX_SENSOR_PHASE, uint8_t, u8) /* 0x80XX06: {"description":"Current phase of a device (one of values in DEVICE_PHASE enum)","label":null} */
