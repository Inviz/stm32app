#ifndef CO_DEV_CIRCUIT_H
#define CO_DEV_CIRCUIT_H
...
/* 0x8400: Device Values Circuit 1
...
struct device_circuit_t {
    ...
    device_sensor_t *current_sensor;
    module_adc_t *adc;;
};
...
ODR_t device_circuit_set_duty_cycle(device_circuit_t *circuit, int16_t value); // 0x84XX01: circuit values duty_cycle
int16_t device_circuit_get_duty_cycle(device_circuit_t *circuit); // 0x84XX01: circuit values duty_cycle
ODR_t device_circuit_set_current(device_circuit_t *circuit, uint16_t value); // 0x84XX02: circuit values current
uint16_t device_circuit_get_current(device_circuit_t *circuit); // 0x84XX02: circuit values current
ODR_t device_circuit_set_voltage(device_circuit_t *circuit, uint16_t value); // 0x84XX03: circuit values voltage
uint16_t device_circuit_get_voltage(device_circuit_t *circuit); // 0x84XX03: circuit values voltage
ODR_t device_circuit_set_consumers(device_circuit_t *circuit, uint8_t value); // 0x84XX04: circuit values consumers
uint8_t device_circuit_get_consumers(device_circuit_t *circuit); // 0x84XX04: circuit values consumers
