...
OD_ACCESSORS(module, timer, properties, prescaler, SUBIDX_TIMER_PRESCALER, uint8_t, u8) /* 0x61XX01: properties */
OD_ACCESSORS(module, timer, properties, initial_subscriptions_count, SUBIDX_TIMER_INITIAL_SUBSCRIPTIONS_COUNT, uint8_t, u8) /* 0x61XX02: properties */
OD_ACCESSORS(module, timer, properties, period, SUBIDX_TIMER_PERIOD, uint32_t, u32) /* 0x61XX03: properties */
OD_ACCESSORS(module, timer, properties, frequency, SUBIDX_TIMER_FREQUENCY, uint32_t, u32) /* 0x61XX04: properties */
OD_ACCESSORS(module, timer, properties, phase, SUBIDX_TIMER_PHASE, uint8_t, u8) /* 0x61XX05: properties */
...
static app_signal_t timer_validate(OD_entry_t *properties_entry) {
    module_timer_properties_t *properties = (module_timer_properties_t *)OD_getPtr(properties_entry, 0x00, 0, NULL);
    (void)properties;
    if (false) {
...
static app_signal_t timer_phase_constructing(module_timer_t *timer, device_t *device) {
    timer->properties = (module_timer_properties_t *)OD_getPtr(device->properties, 0x00, 0, NULL);
    ...
    case 9:
        ...
        break;
#endif
    default: error_printf("TIM%i is not supported by this device", timer->device->seq + 1); return timer->properties->disabled;
    }
    return 0;
}
