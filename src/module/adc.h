...
/* 0x63XX06: null */
#define module_adc_set_phase(adc, value) device_set_property_numeric(adc->device, (uint32_t) value, sizeof(uint8_t), MODULE_ADC_PHASE)
#define module_adc_get_phase(adc) *((uint8_t *) device_get_property_pointer(adc->device, &(uint8_t[sizeof(uint8_t)]{}), sizeof(uint8_t), MODULE_ADC_PHASE)
