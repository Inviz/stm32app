...
OD_ACCESSORS(system, canopen, properties, phase, SUBIDX_CANOPEN_PHASE, uint8_t, u8) /* 0x60XX0a: {} */
OD_ACCESSORS(system, canopen, properties, node_id, SUBIDX_CANOPEN_NODE_ID, uint8_t, u8) /* 0x60XX0b: {} */
OD_ACCESSORS(system, canopen, properties, bitrate, SUBIDX_CANOPEN_BITRATE, uint32_t, u32) /* 0x60XX0c: {} */
