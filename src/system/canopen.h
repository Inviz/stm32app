...
typedef struct system_canopen_values {
    uint8_t parameter_count;
    uint16_t node_id;
    uint32_t bitrate;
...
ODR_t system_canopen_set_node_id(system_canopen_t *canopen, uint16_t value); // 0x80XX01: canopen values node_id
uint16_t system_canopen_get_node_id(system_canopen_t *canopen); // 0x80XX01: canopen values node_id
ODR_t system_canopen_set_bitrate(system_canopen_t *canopen, uint32_t value); // 0x80XX02: canopen values bitrate
uint32_t system_canopen_get_bitrate(system_canopen_t *canopen); // 0x80XX02: canopen values bitrate
