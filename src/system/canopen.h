...
#define system_canopen_get_phase(canopen) *((uint8_t *) OD_getPtr(canopen->device->class->properties, SYSTEM_CANOPEN_PHASE, 0, NULL))
#define system_canopen_set_node_id(canopen, value) OD_set_u8(canopen->device->properties, SYSTEM_CANOPEN_NODE_ID, value, false)
#define system_canopen_get_node_id(canopen) *((uint8_t *) OD_getPtr(canopen->device->class->properties, SYSTEM_CANOPEN_NODE_ID, 0, NULL))
#define system_canopen_set_bitrate(canopen, value) OD_set_u32(canopen->device->properties, SYSTEM_CANOPEN_BITRATE, value, false)
#define system_canopen_get_bitrate(canopen) *((uint32_t *) OD_getPtr(canopen->device->class->properties, SYSTEM_CANOPEN_BITRATE, 0, NULL))
