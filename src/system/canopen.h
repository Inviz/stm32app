...
/* 0x8010: System Values Canopennull */
typedef struct {
    uint8_t node_id;
    uint16_t bitrate;
} system_canopen_values_t;
...
extern device_callbacks_t system_canopen_callbacks;
...
#define SUBIDX_CANOPEN_NODE_ID 0x1
#define SUBIDX_CANOPEN_BITRATE 0x2

ODR_t system_canopen_set_node_id(system_canopen_t *canopen, uint8_t value); // 0x80XX01: canopen values node_id
uint8_t system_canopen_get_node_id(system_canopen_t *canopen); // 0x80XX01: canopen values node_id
ODR_t system_canopen_set_bitrate(system_canopen_t *canopen, uint16_t value); // 0x80XX02: canopen values bitrate
uint16_t system_canopen_get_bitrate(system_canopen_t *canopen); // 0x80XX02: canopen values bitrate
