...
OD_ACCESSORS(system, mcu, properties, phase, SYSTEM_MCU_PHASE, uint8_t, u8) /* 0x60XX04: {"description":null,"label":null} */
OD_ACCESSORS(system, mcu, properties, cpu_temperature, SYSTEM_MCU_CPU_TEMPERATURE, int16_t, i16) /* 0x60XX05: {"description":null,"label":null} */
OD_ACCESSORS(system, mcu, properties, startup_time, SYSTEM_MCU_STARTUP_TIME, uint32_t, u32) /* 0x60XX06: {"description":"In milliseconds","label":null} */
